...
<input type="checkbox"> 30 Initial Sketches: Clear photo evidence of 5 distinct ideation sketches per page per screen size. <br/>

<input type="checkbox"> 3 Paper Prototypes: Documented paper prototypes with insights from peer testing.<br/>

<input type="checkbox"> 1 Mood Board: Visual mood board explicitly linking colors, typography, and styling to target demographic psychology.<br/>

<input type="checkbox"> 3 Figma Prototypes: Screenshots of your final Figma designs and the links to the interactive Figma designs. The prototypes should cover both the homepage and the secondary page across all 3 screen sizes. <br/>

<input type="checkbox"> Comprehensive Design Document: Clear narrative outlining design evolution, user testing takeaways, and explicit design decisions.<br/>