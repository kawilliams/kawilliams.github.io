...
title: From Mainframes to Models
description: An Archival Analysis of Technological Change
permalink: /teaching/hci/design-sprints/archives
---
...
Your first task is to visit the campus Archives and locate 3-5 specific [primary sources](https://owl.purdue.edu/owl/research_and_citation/conducting_research/evaluating_sources_of_information/where_to_begin.html) that document the arrival and adoption of early computing or the internet on campus. These might include (subject to availability):
...
* Incorporate a wide array of multimodal features.  This is crucial: you must include digital copies (scans or photos) of your archival sources as images. You can also include links to current AI policies, videos, etc. 

* Write between 1,000-1,500 words. 

* Sources I expect you to find and cite:
    * 3-5 Primary Sources from the campus Archives (as detailed in [Part 1](#part-1-archival-research)).
...
* Include a Works Cited section at the end in [APA](https://owl.purdue.edu/owl/research_and_citation/apa_style/apa_formatting_and_style_guide/reference_list_basic_rules.html) or [MLA](https://owl.purdue.edu/owl/research_and_citation/mla_style/mla_formatting_and_style_guide/mla_works_cited_page_basic_format.html) format. 
...
**Grading:** Grading will be based on the **[writing rubric](https://docs.google.com/spreadsheets/d/1fXwA-uuAWlF1qxeGOqtw2POri-oh4apuBp44xt_Ym3c/edit?usp=sharing), which differs from the design doc rubric.** 
* Be sure to complete the [peer feedback forms](https://forms.gle/noamVwh14amx4GzL8) linked at the end of the [design document guide](/teaching/hci/design-doc), which will be a large part of your grade. 